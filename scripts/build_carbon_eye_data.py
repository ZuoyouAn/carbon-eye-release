...
def build_provenance_registry(source_registry: list[dict[str, Any]]) -> dict[str, Any]:
    source_context = {
        ...
        "S12": {"temporal_coverage": "current station status only", "spatial_scale": "Suzhou Industrial Park station", "field_units": "AQI and pollutant concentrations", "license_or_terms": "current-state display only; no historical archiving or redistribution", "provenance_status": "best_effort_current_status_only", "processing_script": "backend/carbon_eye_realtime.py"},
    }
    tracked_paths = [
